import { PROCESS_CATALOG, type ProcessRunOptions } from '../../../src/generated/registry/processes.js'
import { formatQty, formatResourceMap } from '../formatters.js'
import { AUTO_GENERATED_HEADER, type GeneratedPage } from '../types.js'

export function buildProcessCatalogPage(): GeneratedPage {
  ...
  const processSections = processRows
    .map(({ processId, process }: { processId: string; process: ProcessRunOptions }) =>
      [
