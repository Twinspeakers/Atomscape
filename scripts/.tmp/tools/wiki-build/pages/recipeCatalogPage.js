...
export function buildRecipeCatalogPage() {
    const recipeRows = [...recipeDefinitions]
        ...
        '- Inputs:',
        formatResourceMap(recipe.inputs),
        '- Outputs:',
        formatResourceMap(recipe.outputs),
    ...
    const uniqueTagCount = new Set(recipeDefinitions.flatMap((recipe) => recipe.tags)).size;
    ...
    const tierDistribution = Object.entries(recipeDefinitions.reduce((map, recipe) => {
