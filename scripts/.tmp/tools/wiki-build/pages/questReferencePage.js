import { firstContractSideQuest, mainQuestDefinitions, tutorialStepDescriptors, } from '../../../src/features/quests/questDefinitions.js';
import { AUTO_GENERATED_HEADER } from '../types.js';
export function buildQuestReferencePage() {
    const stepById = tutorialStepDescriptors.reduce((map, step) => {
        map[step.id] = step;
        return map;
    }, {});
