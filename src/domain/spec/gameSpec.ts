...
export const CREW_SLEEP_SHIFT_START_HOURS = [0, 6, 12, 18] as const
export type CrewSleepShiftStartHour = (typeof CREW_SLEEP_SHIFT_START_HOURS)[number]

export interface CrewRosterMemberDefinition {
  id: string
  name: string
  sleepShiftStartHour: CrewSleepShiftStartHour
}

export const CREW_DEFAULT_ROSTER: readonly CrewRosterMemberDefinition[] = [
...
export type MarketProductId = (typeof MARKET_PRODUCTS)[number]['productId']
